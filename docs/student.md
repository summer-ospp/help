...
学生结项后，发放奖金前，需在系统内下载、手签并扫描上传[学生参与协议-签字版](assets/STUDENT-PARTICIPANT-AGREEMENT.pdf)
...
| 序号 | 日期        | 事项                                           | 备注                                                         |
| ---- | ----------- | ---------------------------------------------- | ------------------------------------------------------------ |
| 1    | 04/13-04/30 | 挑选项目，与导师沟通并准备项目申请材料 | 03/25 起，可在点亮计划管理系统中注册账号并填写个人资料 |
| 2    | 05/21-06/4 | 学生提交项目申请书 |                                                              |
| 3    | 06/16 | 项目申请审核结果公示，学生可在官网查看申请结果 |中选学生会收到系统自动创建的 Gitlab 账号|
| 4   | 06/17-06/30 | 项目预热期                                     |                                                        |
| 5    | 07/1-09/30  | 项目开发                                       |                                     |
...
- 请在[点亮计划管理系统](https://portal.summer-ospp.ac.cn/summer/login)中注册账号并填写个人资料。
...
- 通过[点亮计划管理系统](https://portal.summer-ospp.ac.cn/summer/login)提交申请材料。
...
- 学生需要在里程碑节点之前向组委会平台仓库提交完整项目代码（此要求主要面向过程产出代码未存放在组委会平台的学生），并将相应的报告提交至[点亮计划管理系统](https://portal.summer-ospp.ac.cn/summer/login) 。


#### 5. 进行项目研发，并提交研发成果供结项考核
...
## 四. 学生奖金说明
   ...
   每个项目奖金总额根据项目难度分为 12000 元、 8000 元（注：奖金数额为税前人民币金额）
