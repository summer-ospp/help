...
学生中选后，发放中期奖金前，需在系统内下载、手签并扫描上传[学生参与协议-签字版](assets/STUDENT-PARTICIPANT-AGREEMENT.pdf)
...
- 学生需要在里程碑节点之前向组委会平台仓库提交完整项目代码（此要求主要面向过程产出代码未存放在组委会平台的学生），并将相应的报告提交至[暑期2021 报名系统](https://portal.summer-ospp.ac.cn/summer/login) ，里程碑节点包括中期考核、结项考核两个时间点。
